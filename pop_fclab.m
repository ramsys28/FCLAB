...
if nargin < 3
    ...
    uilist = { ...
      ...
      { 'Style', 'checkbox', 'string' 'Auto Compete' 'value' 0 'tag' 'metric_all' 'Callback', @popupCallback_autocmpl} ...
...
function popupCallback_autocmpl(obj,event)
    if obj.Value==1
         ...
         set(findobj('Tag', 'frb4'),'String','[13 30]')
         set(findobj('Tag', 'frb4_name'),'String','Beta')
         set(findobj('Tag', 'frb4'),'String','[30 45]')
         set(findobj('Tag', 'frb4_name'),'String','Gamma')
    else
        handle = findobj('Tag', 'metric');
        set(handle,'Visible','On')
    end

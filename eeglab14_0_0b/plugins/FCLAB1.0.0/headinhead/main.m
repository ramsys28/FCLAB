...
figure;showcs(imag(cs),locs_2D);  %show the imaginary part of the cross-spectrum
...
figure;showcs(cs,locs_2D,para); %plots 30 channels as 'head-in-head' with the above changes 

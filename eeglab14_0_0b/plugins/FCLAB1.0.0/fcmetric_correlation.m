...
mf = size(EEG.FC.parameters.bands,1);
[m, n, o] = size(inEEG.data);
for i = 1:mf
    testEEG = inEEG;
    freq_range=str2num(EEG.FC.parameters.bands{i,1});
    ...
    eval(['outEEG.FC.Correlation.' strrep(EEG.FC.parameters.bands{i,2},' ','_') '.adj_matrix=temp_adj;']);
end;
